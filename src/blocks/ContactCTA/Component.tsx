    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="glass-dark rounded-3xl p-8 md:p-12 lg:p-16 max-w-4xl mx-auto text-center">
          ...
          {description && (
            <div className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
          ...
          {primaryCTA?.label && (
            <CMSLink
              {...primaryCTA}
              size="lg"
              className="bg-white text-primary hover:bg-white/90 transition-opacity px-8 py-4 rounded-xl font-semibold shadow-lg inline-flex items-center gap-2"
            />
          )}
        </div>
      </div>
