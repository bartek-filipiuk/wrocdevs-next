...
export interface Event {
  ...
  /**
   * Link to the online meeting (Zoom, Google Meet, etc.)
   */
  ...
  /**
   * Link to external registration page (Eventbrite, Meetup, etc.)
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CoursesShowcaseBlock".
 */
export interface CoursesShowcaseBlock {
  sectionTitle?: string | null;
  sectionDescription?: string | null;
  courses?:
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CoursesShowcaseBlock_select".
 */
export interface CoursesShowcaseBlockSelect<T extends boolean = true> {
  sectionTitle?: T;
  sectionDescription?: T;
  courses?:
    | T
